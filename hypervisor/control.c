...
static int cell_create(struct per_cpu *cpu_data, unsigned long config_address)
{
	...
	ddr_xmpu0_region_config.enable =        0;  
	...
	ddr_xmpu0_status_config.def_wr_allowed =1;
	ddr_xmpu0_status_config.def_rd_allowed =1;
	...
	// fpd_xmpu_region_config.wrallowed =     1; //allowed
	// fpd_xmpu_region_config.rdallowed =     1; //allowed
