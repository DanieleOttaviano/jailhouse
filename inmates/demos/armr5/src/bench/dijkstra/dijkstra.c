...
*/
static struct _NODE dijkstra_rgnNodes[ NUM_NODES ];

static int dijkstra_queueCount;
static int dijkstra_queueNext;
static struct _QITEM *dijkstra_queueHead;
static struct _QITEM dijkstra_queueItems[ QUEUE_SIZE ];

static int dijkstra_checksum = 0;
