...
class CellConfig:
    _HEADER_FORMAT = '=5sBH32s4xIIIIIIIIIIIIIQ8x32x'
    ...
    def __init__(self, data, root_cell=False):
        ...
        try:
            ...
            mem_region_offs = cpu_set_offs + self.cpu_set_size + self.rcpu_set_size + self.fpga_regions_size
            self.memory_regions = []
